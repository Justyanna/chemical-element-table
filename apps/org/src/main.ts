...
import { DashboardPageComponent } from "./app/modules/dashboard/pages/dashboard-page/dashboard-page.component";
import { InMemoryWebApiModule } from 'angular-in-memory-web-api';
import { InMemoryDataService } from './app/modules/dashboard/services/in-memory-data.service';
